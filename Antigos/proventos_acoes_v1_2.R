...
tab_desd <- xml2::read_html(remDr$getPageSource()[[1]]) %>%
...
# url <- "https://br.advfn.com/bolsa-de-valores/bovespa/itau-unibanco-ITUB3/dividendos"
url <- "https://www.guiainvest.com.br/provento/default.aspx?sigla=hgtx3"
...
tab_prov_hist <- xml2::read_html(remDr$getPageSource()[[1]]) %>%
